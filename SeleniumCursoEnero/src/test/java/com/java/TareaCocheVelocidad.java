...
public class TareaCocheVelocidad {
	...
	public static void CocheVelocidad() {
		int velocidadActual = 100; // KM*H
		boolean carretera = true; // Si le pongo falso no realiza nada porque no esta declarado en ninguna
									// condicion
