...
@Test
public class CreateUserDisabled {

	String username, password, newuser, newEmployee, password2, msgNoRecords,status;
	...
	public void tc004AdminCreateUserDisable() {
			// Step1
			...
			//Step8
			Reporter.log("Change Status Disable");
			///driver.findElement(By.xpath("//*[@id=\"systemUser_status\"]/option[2]")).click();
			Select drpStatus = new Select (driver.findElement(By.xpath("//*[@id=\"systemUser_status\"]")));
